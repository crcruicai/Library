...
namespace ListViewCollectionDemo
{
	...
	/// </summary>
	public class FrmPrintableListView : System.Windows.Forms.Form
	{
		private CRC.Controls.PrintableListView m_list;
		...
		{
			this.m_list = new CRC.Controls .PrintableListView();
