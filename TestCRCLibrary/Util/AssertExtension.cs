...
namespace TestCRCLibrary
{
    ...
    public static class AssertExtension
    {
        ...
        /// <param name="obj1">要比较的第一个泛型类型数据。单元测试要求泛型类型数据与 actual 不匹配。</param>
        /// <param name="obj2"> 要比较的第二个泛型类型数据。这是单元测试生成的泛型类型数据。</param>
        public static void AreNotEqualWith<T>(this T obj1, T obj2)
        {
        ...
        public static void IsNotNullWith<T>(this T obj) where T : class
        {
        ...
        public static void IsNotNullWith<T>(this T obj, string message) where T : class
        {
        ...
        public static void IsNotNullWith<T>(this T obj, string message, object[] parameters) where T : class
        {
        ...
        public static void IsNullWith<T>(this T obj) where T : class
        {
            Assert.IsNotNull(obj);
        }
        ...
        /// <param name="obj">要验证的对象为 null。</param>
        /// <param name="message">断言失败时显示的消息。在单元测试结果中可以看到此消息。</param>
        public static void IsNullWith<T>(this T obj, string message) where T : class
        {
            Assert.IsNotNull(obj, message);
        }
        /// <summary>
        ...
        /// <param name="message">断言失败时显示的消息。在单元测试结果中可以看到此消息。</param>
        /// <param name="parameters">设置 message 格式时使用的参数的数组。</param>
        public static void IsNullWith<T>(this T obj, string message, object[] parameters) where T : class
        {
            Assert.IsNotNull(obj, message, parameters);
        }
        /// <summary>
