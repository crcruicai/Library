...
*/
    ...
    class Test
    {
        static void main(string[] args)
        {
            ...
            Console.WriteLine(imDriveC.IniReadValue("Name1"));



            INIManager im = new INIManager();
            im.IniWriteValue("姓", "Cai");
            im.IniWriteValue("名", "Benson");

            Console.WriteLine(im.IniReadValue("姓"));
