...
namespace CRC.Controls
{
    ...
    public class ListViewFilter : System.Windows.Forms.ListView
    {
        ...
        /// </summary>
        private bool hdr_filter = false;             
        /// <summary>
        ///  Sort column
        /// </summary>
        private int srt_column = 0;                  
        /// <summary>
        /// Sort ascending/descending
        /// </summary>
        private bool srt_sorder = true;              
        /// <summary>
        ///  Sort data type comparison
        /// </summary>
        private LVFDataType srt_datype = LVFDataType.String; 
        /// <summary>
        ///  Ignore case on filter
        /// </summary>
        private bool flt_ignore = false;              
        /// <summary>
        /// Shade color
        /// <summary>
        /// </summary>
        private Color col_scolor = Color.WhiteSmoke;  
        ///  Display shade color
        /// </summary>
        private bool col_shaded = true;               
        /// <summary>
        /// Array of LVFFliters active
        /// </summary>
        private ArrayList itm_filtrs = new ArrayList();   
        /// <summary>
        ///  Filtered out items
        /// </summary>
        private ArrayList itm_filtrd = new ArrayList();   
        /// <summary>
        /// Held out items
        /// </summary>
        private ArrayList itm_holder = new ArrayList();   
        /// <summary>
        /// Filter button column
        /// </summary>
        private int mnu_column = 0;                  
        /// <summary>
        /// float value for compare
        /// </summary>
        private float cmp_float1 = float.MaxValue;   
        /// <summary>
        /// float value for compare
        /// </summary>
        private float cmp_float2 = float.MaxValue;   
        /// <summary>
        /// date value for compare
        /// </summary>
        private DateTime cmp_datim1 = DateTime.MaxValue;  
        /// <summary>
        ///  date value for compare
        /// </summary>
        private DateTime cmp_datim2 = DateTime.MaxValue;  
        ...
        private MenuItem mnu_DataType = new MenuItem("&Data type");
        private MenuItem mnu_Alignment = new MenuItem("&Alignment");
        private MenuItem mnu_ClearFilter = new MenuItem("&Clear filter");
        private MenuItem mnu_IgnoreCase = new MenuItem("&Ignore case");
        private MenuItem mnu_String = new MenuItem("&String");
        private MenuItem mnu_Number = new MenuItem("&Number");
        private MenuItem mnu_Date = new MenuItem("&Date");
        private MenuItem mnu_AlignmentLeft = new MenuItem("&Left");
        private MenuItem mnu_AlignmentRight = new MenuItem("&Right");
        private MenuItem mnu_AlignmentCenter = new MenuItem("&Center");
        ...
        private void InitializeComponent()
        {
            ...
            // mnu_filter
            //
            this.mnu_filter.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] { this.mnu_DataType, this.mnu_Alignment, this.mnu_ClearFilter, this.mnu_IgnoreCase });
            this.mnu_filter.Popup += new System.EventHandler(this.ContextMenuPopup);
            // 
            // mnu_datype
            // 
            this.mnu_DataType.Index = 0;
            this.mnu_DataType.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] { this.mnu_String, this.mnu_Number, this.mnu_Date });
            // 
            // mnu_alignt
            // 
            this.mnu_Alignment.Index = 1;
            this.mnu_Alignment.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] { this.mnu_AlignmentLeft, this.mnu_AlignmentRight, this.mnu_AlignmentCenter });
            // 
            // mnu_clearf
            // 
            this.mnu_ClearFilter.DefaultItem = true;
            this.mnu_ClearFilter.Index = 2;
            this.mnu_ClearFilter.Click += new System.EventHandler(this.MenuItemClick);
            // 
            // mnu_refrsh
            // 
            this.mnu_IgnoreCase.Index = 3;
            this.mnu_IgnoreCase.Click += new System.EventHandler(this.MenuItemClick);
            // 
            // mnu_strflt
            // 
            this.mnu_String.Index = 0;
            this.mnu_String.RadioCheck = true;
            this.mnu_String.Click += new System.EventHandler(this.MenuItemClick);
            // 
            // mnu_nbrflt
            // 
            this.mnu_Number.Index = 1;
            this.mnu_Number.RadioCheck = true;
            this.mnu_Number.Click += new System.EventHandler(this.MenuItemClick);
            // 
            // mnu_datflt
            // 
            this.mnu_Date.Index = 2;
            this.mnu_Date.RadioCheck = true;
            this.mnu_Date.Click += new System.EventHandler(this.MenuItemClick);
            // 
            // mnu_alignl
            // 
            this.mnu_AlignmentLeft.Index = 0;
            this.mnu_AlignmentLeft.RadioCheck = true;
            this.mnu_AlignmentLeft.Click += new System.EventHandler(this.MenuItemClick);
            // 
            // mnu_alignr
            // 
            this.mnu_AlignmentRight.Index = 1;
            this.mnu_AlignmentRight.RadioCheck = true;
            this.mnu_AlignmentRight.Click += new System.EventHandler(this.MenuItemClick);
            // 
            // mnu_alignc
            // 
            this.mnu_AlignmentCenter.Index = 2;
            this.mnu_AlignmentCenter.RadioCheck = true;
            this.mnu_AlignmentCenter.Click += new System.EventHandler(this.MenuItemClick);
        ...
        private void MenuItemClick(object sender, System.EventArgs e)
        {
            ...
            if (((MenuItem)sender).Parent == mnu_Alignment) this.Invalidate();
        ...
        private void ContextMenuPopup(object sender, System.EventArgs e)
        {
            ...
            switch (hdr_contrl.DataType[mnu_column])
            {
                case LVFDataType.Date:
                    mnu_String.Checked = false;
                    mnu_Number.Checked = false;
                    mnu_Date.Checked = true;
                    break;
                case LVFDataType.Number:
                    mnu_String.Checked = false;
                    mnu_Number.Checked = true;
                    mnu_Date.Checked = false;
                    break;
                default:
                    mnu_String.Checked = true;
                    mnu_Number.Checked = false;
                    mnu_Date.Checked = false;
                    break;
            }
            ...
            mnu_String.Enabled = !mnu_String.Checked;
            mnu_Number.Enabled = !mnu_Number.Checked;
            mnu_Date.Enabled = !mnu_Date.Checked;

            // also set the current alignment
            switch (hdr_contrl.Alignment[mnu_column])
            {
                case HorizontalAlignment.Center:
                    mnu_AlignmentLeft.Checked = false;
                    mnu_AlignmentRight.Checked = false;
                    mnu_AlignmentCenter.Checked = true;
                    break;
                case HorizontalAlignment.Right:
                    mnu_AlignmentLeft.Checked = false;
                    mnu_AlignmentRight.Checked = true;
                    mnu_AlignmentCenter.Checked = false;
                    break;
                default:
                    mnu_AlignmentLeft.Checked = true;
                    mnu_AlignmentRight.Checked = false;
                    mnu_AlignmentCenter.Checked = false;
                    break;
            }
            ...
            // disable the checked DataType menu item
            mnu_AlignmentLeft.Enabled = !mnu_AlignmentLeft.Checked;
            mnu_AlignmentRight.Enabled = !mnu_AlignmentRight.Checked;
            mnu_AlignmentCenter.Enabled = !mnu_AlignmentCenter.Checked;

            // set the checked state of the case insensitive
            mnu_IgnoreCase.Checked = flt_ignore;
