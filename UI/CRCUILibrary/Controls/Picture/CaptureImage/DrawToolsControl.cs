...
namespace CRC.Controls
{
    ...
    public partial class DrawToolsControl : UserControl
    {
        ...
        private static readonly object EventButtonCopyClick = new object();
        #endregion
        ...
        public event EventHandler ButtonCopyClick
        {
            add { base.Events.AddHandler(EventButtonCopyClick, value); }
            remove { base.Events.RemoveHandler(EventButtonCopyClick, value); }
        }
        #endregion
        ...
        protected virtual void OnButtonCopyClick(EventArgs e)
        {
            EventHandler handler =
                base.Events[EventButtonCopyClick] as EventHandler;
            if (handler != null)
            {
                handler(this, e);
            }
