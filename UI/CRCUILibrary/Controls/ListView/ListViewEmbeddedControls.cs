...
namespace CRC.Controls
{
    ...
    /// <summary>
	/// <para>可以在单元格嵌入控件的ListView.</para>
	/// </summary>
	public class ListViewEmbeddedControls : ListView
	{
        ...
        /// <summary> <para>结构调整，保持一个嵌入式的控制信息</para>
        ...
        public ListViewEmbeddedControls() { }

        /// <summary> <para>检索列的顺序出现</para>
		...
		public void RemoveEmbeddedControl(Control c)
		{
			...
			{
				EmbeddedControl ec = _embeddedControls[i];
				if (ec.Control == c)
				{
					c.Click -= new EventHandler(_embeddedControl_Click);
