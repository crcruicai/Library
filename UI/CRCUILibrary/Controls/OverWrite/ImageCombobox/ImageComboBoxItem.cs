...
namespace CRC.Controls
{
    ...
    public class ImageComboBoxItem :  IDisposable, ISerializable     
    {
        #region Fields
        ...
        public ImageComboBoxItem( string text, int imageIndex, int level) : this()
        {
            _text = text;
        ...
        public ImageComboBoxItem(string text, string imageKey, int level): this()
        {
            _text = text;
        ...
        protected ImageComboBoxItem(SerializationInfo info, StreamingContext context): this()
        {
        ...
        [Editor( EditorAssemblyName.ImageIndexEditor, typeof(UITypeEditor))]
        [RefreshProperties(RefreshProperties.Repaint)]
        [DesignerSerializationVisibility( DesignerSerializationVisibility.Hidden)]
        ...
        internal class ImageComboBoxItemImageIndexer: ImageIndexer
        {
