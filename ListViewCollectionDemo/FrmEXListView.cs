...
namespace ListViewCollectionDemo
{
    class MyForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            imglst_genre.Images.Add(ListViewCollectionDemo.Properties.Resources.music);
            imglst_genre.Images.Add(ListViewCollectionDemo.Properties.Resources.love);
            imglst_genre.Images.Add(ListViewCollectionDemo.Properties.Resources.comedy);
            imglst_genre.Images.Add(ListViewCollectionDemo.Properties.Resources.drama);
            imglst_genre.Images.Add(ListViewCollectionDemo.Properties.Resources.horror);
            imglst_genre.Images.Add(ListViewCollectionDemo.Properties.Resources.family);
            //excmbx_genre
            EXComboBox excmbx_genre = new EXComboBox();
            excmbx_genre.DropDownStyle = ComboBoxStyle.DropDownList;
            excmbx_genre.HighLightBrush = Brushes.Goldenrod;
            excmbx_genre.ItemHeight = 20;
            excmbx_genre.Items.Add(new EXComboBox.ImageItem(imglst_genre.Images[0], "Music"));
            excmbx_genre.Items.Add(new EXComboBox.ImageItem(imglst_genre.Images[1], "Romantic"));
            excmbx_genre.Items.Add(new EXComboBox.ImageItem(imglst_genre.Images[2], "Comedy"));
            excmbx_genre.Items.Add(new EXComboBox.ImageItem(imglst_genre.Images[3], "Drama"));
            excmbx_genre.Items.Add(new EXComboBox.ImageItem(imglst_genre.Images[4], "Horror"));
            excmbx_genre.Items.Add(new EXComboBox.ImageItem(imglst_genre.Images[5], "Family"));
            excmbx_genre.Items.Add(new EXComboBox.MultipleImagesItem(new ArrayList(new object[] { ListViewCollectionDemo.Properties.Resources.love, ListViewCollectionDemo.Properties.Resources.comedy }), "Romantic comedy"));
            //excmbx_rate
            EXComboBox excmbx_rate = new EXComboBox();
            excmbx_rate.HighLightBrush = Brushes.Goldenrod;
            ...
            imglst_rate.Images.Add(ListViewCollectionDemo.Properties.Resources.rate);
            for (int i = 1; i < 6; i++)
            {
                ...
                excmbx_rate.Items.Add(new EXComboBox.MultipleImagesItem("", _arlst1, i.ToString()));
            }
            //lstv
            lstv = new EXListView();
            lstv.SortColumnBrush = SystemBrushes.ControlLight;
            lstv.HighLightBrush = Brushes.Goldenrod;
            lstv.GridLines = true;
            ...
            colimglst.Images.Add("down", ListViewCollectionDemo.Properties.Resources.down);
            colimglst.Images.Add("up", ListViewCollectionDemo.Properties.Resources.up);
            ...
            boolcol.TrueImage = ListViewCollectionDemo.Properties.Resources._true;
            boolcol.FalseImage = ListViewCollectionDemo.Properties.Resources._false;
        ...
        private void llbl_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            ProgressBar p = subitem.Control as ProgressBar;
        ...
        private void lstv_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                toolstripstatuslabel1.Text = ((EXListViewSubItemAB)subitem).Value;
            }
        }
        ...
        private void UpdateProgressBarMethod(object pb)
        {
            ...
            LinkLabel l = ((LinkLabel)((EXControlListViewSubItem)item.SubItems[4]).Control);
        ...
        {
            ((EXMultipleImagesListViewSubItem)lstv.Items[1].SubItems[2]).Images.Clear();
