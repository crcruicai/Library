...
namespace CRC.Controls
{
    ...
    public class ColorButton : Button
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (base.Enabled)
            {
                switch (this.ControlState)
                {
                    ...
                    case ControlState.Pressed:
                        baseColor = this.GetColor(this._baseColor, 0, -85, -60, -35);
                        borderColor = this._baseColor;
                        break;
                    default:
            ...
            TextRenderer.DrawText(graphics, this.Text, this.Font, bounds, this.ForeColor, ColorButton.GetTextFormatFlags(this.TextAlign, this.RightToLeft == RightToLeft.Yes));
        }
